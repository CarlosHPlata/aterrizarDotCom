...
class AgreementSignStepTest {
    ...
    void shouldRequestAgreementSignedFieldWhenNotProvided() {
        ...
        assertTrue(updatedContext.checkinResponse().providedFields().contains(RequiredField.AGREEMENT_SIGNED));
    }
    ...
    void shouldCaptureAgreementSignedFieldWhenProvided() {
        var context = MockContext.initializedMock(CountryCode.US)
                ...
                .withCheckinRequest(builder -> builder
                        .providedFields(Map.of(RequiredField.AGREEMENT_SIGNED, "true")));
