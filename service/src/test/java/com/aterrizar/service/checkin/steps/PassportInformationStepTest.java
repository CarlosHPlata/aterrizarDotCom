...
class PassportInformationStepTest {
    ...
    void shouldRequestThePassportToTheUserWhenIsNotSet() {
        ...
        assertTrue(updatedContext.checkinResponse().providedFields().contains(RequiredField.PASSPORT_NUMBER));
    }
    ...
    void shouldCaptureThePassportWhenIsProvided() {
        ...
        var context = MockContext.initializedMock(CountryCode.US)
                .withUserInformation(builder -> builder.passportNumber(null))
                .withCheckinRequest(requestBuilder -> requestBuilder
                        .providedFields(Map.of(RequiredField.PASSPORT_NUMBER, passportNo)));
