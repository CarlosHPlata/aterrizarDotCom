...
public interface Step {
  ...
  /**
   * Executes the step. If the `when` condition is met, the `onExecute` method is called. Otherwise,
   * it returns a successful result with the current context.
   *
  ...
  /**
   * Determines whether the step should be executed. By default, this method always returns `true`.
   *
