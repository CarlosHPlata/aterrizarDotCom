...
/**
 * The `Step` interface defines the structure for a step in a flow process (Chain of responsibility).
 * <p>
 * Design Patterns Used:
 * <p>
 * - <b>Template Method</b>: The `execute` method provides a template for the execution process,
...
public interface Step {
    ...
    /**
     * Defines the main behavior of the step when executed.
     * This method must be implemented by all classes that implement the `Step` interface.
     *
     * @param context the context in which the step is executed
     * @return the result of the step execution
     */
