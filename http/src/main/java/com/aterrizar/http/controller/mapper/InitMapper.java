...
public class InitMapper implements RequestMapperStrategy<InitContext, InitResponseData, InitRequestData> {
    ...
    public ResponseEntity<InitResponseData> mapContextToResponse(InitContext context) {
        var response = InitResponseData.builder()
